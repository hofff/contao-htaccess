...
/**
 * Class HtaccessExpires
 *
 * Expires htaccess configuration module.
 *
 * @copyright  Tristan Lins 2011
 * @author     Tristan Lins <info@infinitysoft.de>
 * @package    htaccess Generator
 */
class HtaccessExpires implements HtaccessModule
{
	/**
	...
	{
		$objTemplate = new BackendTemplate('htaccess_expires');
