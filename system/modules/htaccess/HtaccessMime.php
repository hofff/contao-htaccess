 ...
 * Class HtaccessMime
 *
 * Mime htaccess configuration module.
 *
 * @copyright  Tristan Lins 2011
 * @author     Tristan Lins <info@infinitysoft.de>
 * @package    htaccess Generator
 */
class HtaccessMime implements HtaccessModule
{
	/**
	...
	{
		$objTemplate = new BackendTemplate('htaccess_mime');
		$objTemplate->submodules = $strSubmoduleCode;
		$objTemplate->mimetypes  = deserialize($GLOBALS['TL_CONFIG']['htaccess_mime_types'], true);
